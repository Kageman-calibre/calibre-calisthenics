...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "relative rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10 text-card-foreground shadow-2xl hover:shadow-3xl hover:bg-white/10 transition-all duration-300 group overflow-hidden",
      className
    )}
    {...props}
  >
