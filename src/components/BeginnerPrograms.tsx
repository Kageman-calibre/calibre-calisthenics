...
const BeginnerPrograms = () => {
  ...
  const [selectedProgram, setSelectedProgram] = useState<BeginnerProgram | null>(null);
  ...
  const handleWorkoutStart = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `You've started "${selectedProgram.name}". Let's begin your fitness journey!`,
      });
  ...
  const handleSaveAdjustments = (adjustments: any) => {
    ...
    toast({
      ...
      description: "Your exercise modifications have been applied to the workout.",
    });
  ...
  // Mock exercise data for the selected program
  const getExercisesForProgram = (program: BeginnerProgram) => {
    return [
      { id: 'push-ups', name: 'Push-ups', defaultSets: 3, defaultReps: '8-12', defaultRest: '60s' },
      { id: 'squats', name: 'Bodyweight Squats', defaultSets: 3, defaultReps: '12-15', defaultRest: '45s' },
      { id: 'plank', name: 'Plank Hold', defaultSets: 3, defaultReps: '30', defaultRest: '45s' },
      { id: 'lunges', name: 'Lunges', defaultSets: 2, defaultReps: '10-12', defaultRest: '60s' }
    ];
  };
  ...
  return (
    <>
      ...
      {/* Exercise Adjustment Modal */}
      {showAdjustments && selectedProgram && (
        <ExerciseAdjustment
          exercises={getExercisesForProgram(selectedProgram)}
